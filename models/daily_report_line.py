...
class DailyReportManagementLine(models.Model):
    _name = 'daily.report.management.line'
    ...
    project_ids = fields.Many2many('project.project', related="daily_report_management_id.project_ids", string="Projects")
